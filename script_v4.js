...
const defaultChimes6 = [
    { "name": "朝課外", "time": "07:40", "alertEnabled": true, "alertMinutes": 30, "lockEnabled": true, "lockMinutes": 30 },
    { "name": "朝のHR", "time": "08:40", "alertEnabled": true, "alertMinutes": 10, "lockEnabled": true, "lockMinutes": 30 },
    { "name": "1限目", "time": "09:00", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "2限目", "time": "10:00", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "3限目", "time": "11:05", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "4限目", "time": "12:05", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "5限目", "time": "13:40", "alertEnabled": true, "alertMinutes": 10, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "6限目", "time": "14:40", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "掃除", "time": "15:35", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 5 },
    { "name": "帰りHR", "time": "15:50", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 5 }
];

const defaultChimes7 = [
    { "name": "朝課外", "time": "07:40", "alertEnabled": true, "alertMinutes": 30, "lockEnabled": true, "lockMinutes": 30 },
    { "name": "朝のHR", "time": "08:40", "alertEnabled": true, "alertMinutes": 10, "lockEnabled": true, "lockMinutes": 30 },
    { "name": "1限目", "time": "09:00", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "2限目", "time": "10:00", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    ...
    { "name": "5限目", "time": "13:40", "alertEnabled": true, "alertMinutes": 10, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "6限目", "time": "14:40", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "7限目", "time": "15:40", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 3 },
    { "name": "掃除", "time": "16:35", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 5 },
    { "name": "帰りHR", "time": "16:50", "alertEnabled": true, "alertMinutes": 5, "lockEnabled": true, "lockMinutes": 5 }
];
...
async function loadChimes() {
    ...
    if (!saved || useDefault) {
        ...
        // 1(月), 3(水), 5(金) は 6限。それ以外（2:火, 4:木など）は 7限とする
        if (dayOfWeek === 1 || dayOfWeek === 3 || dayOfWeek === 5) {
            chimeSchedule = JSON.parse(JSON.stringify(defaultChimes6));
        } else {
            chimeSchedule = JSON.parse(JSON.stringify(defaultChimes7));
        }
...
function loadApps() {
    ...
    const defaultAppsList = [
        { name: "待ち時間", icon: "⏳", url: "wait-time.html", key: "w", mode: "fullscreen" },
        { name: "時刻表", icon: "⏱️", url: "train-timetable.html", key: "t", mode: "fullscreen" },
        { name: "タイムテーブル", icon: "📅", url: "timetable.html", key: "s", mode: "fullscreen" },
        { name: "メニュー一覧", icon: "🍽️", url: "menu-list.html", key: "l", mode: "fullscreen" }
    ];

    const ORDER_VERSION = 'v4_order_final_v11';
        ...
        if (response.ok) {
            ...
            if (data) {
                ...
                if (data.apps) {
                    ...
                    checkAndSet('naviAppsOrderVersion', 'v4_order_final_v11');
                }
